(function () {
  ...
  // }
    ...
    var styleCycle = [
      { name: 'rigid',    colWidth: 90 * sizeScale, innerWidthPct: 100 * sizeScale, marginY: 0,  ratios: [3 / 4, 1 / 1],       border: true,  shadow: false, rotate: 0 },
      { name: 'floating', colWidth: 90 * sizeScale, innerWidthPct: 80 * sizeScale,  marginY: 20, ratios: [4 / 5, 1 / 1],       border: false, shadow: true,  rotate: 0 },
      { name: 'sparse',   colWidth: 100 * sizeScale, innerWidthPct: 90 * sizeScale,  marginY: 36, ratios: [5 / 6],              border: false, shadow: true,  rotate: 0 },
  ...
  function renderPhotoGridLightbox(entry) {
    elements.lightboxOverlay.classList.add('lb-photo-grid');
